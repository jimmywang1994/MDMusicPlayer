...
public class MainActivity extends Activity {
    ...
    private void setToolBar(){
        ...
        SimpleAdapter adapter = new SimpleAdapter(this, LeftMenu.getData(),R.layout.left_menu_layout,LeftMenu.getFroms(),LeftMenu.getTos());
    ...
    private void findViews(){
        ...
        mLeftMenuListView = (ListView)findViewById(R.id.lv_left_menu);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViews();
        setToolBar();
        SearchHandler.addEditTextSearchListenerAndHandler(mEditTextSearch,(FrameLayout)findViewById(R.id.container));
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.search_btn) {
            if (mEditTextSearch.getVisibility()==View.VISIBLE){
                AnimationUtil.EndEditTextSearchAnimation(mEditTextSearch);
            }
            else {
                AnimationUtil.StartEditTextSearchAnimation(mEditTextSearch);
            }
            return true;
        }
